...
if (!class_exists('WT_VC_EXTENSIONS')) {
	...
	class WT_VC_EXTENSIONS {
		...
		public $WT_VCSC_Elements = array(
			...
			"WT Clients"					        => array("setting" => "Clients",                  "file" => "clients",                   "type" => "internal",		"active" => "true"),
			"WT Team"					            => array("setting" => "Team",                     "file" => "team",     	             "type" => "internal",		"active" => "true"),
			"WT Team Slider"					    => array("setting" => "TeamSlider",               "file" => "team_slider",     	         "type" => "internal",		"active" => "true"),
			...
			"WT Pricing Table"					    => array("setting" => "PricingTable",             "file" => "pricing_table",             "type" => "internal",		"active" => "true"),
			"WT Custom Heading"					    => array("setting" => "CustomHeading",            "file" => "custom_heading",            "type" => "internal",		"active" => "true"),
			"WT Section Headings"				    => array("setting" => "SectionHeadings",          "file" => "section_headings",          "type" => "internal",		"active" => "true"),
			"WT Galler Grid"				        => array("setting" => "GalleryGrid",              "file" => "gallery_grid",              "type" => "internal",		"active" => "true"),
			"WT Google Map"				            => array("setting" => "GoogleMap",                "file" => "gmap",                      "type" => "internal",		"active" => "true"),
			
			// External Plugins
			"WT Portfolio"				            => array("setting" => "Portfolio",                "file" => "portfolio",     	         "type" => "external",		"active" => "true"),
		);
			...
			foreach ($this->WT_VCSC_Elements as $ElementName => $element) {
					if ($element['active'] == "true") {
						if ($element['type'] == 'internal') {
							...
							if ( is_plugin_active( 'whoathemes_portfolio/wt_portfolio.php' ) ) {
							*/
							if ( class_exists('Whoathemes_Portfolio')) {
								// Initialize external plugins as Whoathemes Portfolio, etc...
								require_once(THEME_VC_EXTEND_PLUGINS . '/wt_vcsc_' . $element['file'] . '.php');
							}
						}
					}
				}
