...
function wt_save_markers_data() {
    jQuery(document).ready(function($) {
        var marker_data_textarea = $('#vc_properties-panel .marker_data');
        if($('#vc_properties-panel .wt_marker_item').length > 0) {
            var data = {},
                i = 0;
            $('#vc_properties-panel .wt_marker_item').each(function() {
                var $this = $(this),
                    row = {},
