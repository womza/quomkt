...
function wt_enqueue_styles(){
	...
	wp_enqueue_style('theme-etlinefont', THEME_CSS.'/etlinefont.css', array(), null, 'all');
	...
	switch($skin){		
		case 'marine':
			wp_enqueue_style('theme-marine', THEME_CSS.'/skins/marine.css', array(), null, 'all');
			break;
		case 'cyan':
		...
		case 'green':
			...
			break;
		case 'eton-blue':
			wp_enqueue_style('theme-eton-blue', THEME_CSS.'/skins/eton-blue.css', array(), null, 'all');
			break;
		case 'june-bud':
			wp_enqueue_style('theme-june-bud', THEME_CSS.'/skins/june-bud.css', array(), null, 'all');
			break;
		case 'dark-green':
			wp_enqueue_style('theme-dark-green', THEME_CSS.'/skins/dark-green.css', array(), null, 'all');
			break;
		case 'turquoise':
		...
		case 'orange':
			...
			break;
		case 'cadmium-orange':
			wp_enqueue_style('theme-cadmium-orange', THEME_CSS.'/skins/cadmium-orange.css', array(), null, 'all');
			break;
		case 'camel':
			wp_enqueue_style('theme-camel', THEME_CSS.'/skins/camel.css', array(), null, 'all');
			break;
		case 'brown':
			wp_enqueue_style('theme-brown', THEME_CSS.'/skins/brown.css', array(), null, 'all');
			break;
		case 'pastel-brown':
			wp_enqueue_style('theme-pastel-brown', THEME_CSS.'/skins/pastel-brown.css', array(), null, 'all');
			break;
		case 'red':
			wp_enqueue_style('theme-red', THEME_CSS.'/skins/red.css', array(), null, 'all');
			break;
		case 'carmine-pink':
			wp_enqueue_style('theme-carmine-pink', THEME_CSS.'/skins/carmine-pink.css', array(), null, 'all');
			break;
		case 'pink':
			wp_enqueue_style('theme-pink', THEME_CSS.'/skins/pink.css', array(), null, 'all');
			break;
		case 'antique-ruby':
			wp_enqueue_style('theme-antique-ruby', THEME_CSS.'/skins/antique-ruby.css', array(), null, 'all');
			break;
		case 'yellow':
			wp_enqueue_style('theme-yellow', THEME_CSS.'/skins/yellow.css', array(), null, 'all');
			break;
		case 'violet':
			wp_enqueue_style('theme-violet', THEME_CSS.'/skins/violet.css', array(), null, 'all');
			break;
		case 'grey':
