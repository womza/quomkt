...
if(!function_exists('wt_googlefonts_getfonts')){
	function wt_googlefonts_getfonts(){
		return array(
			...
			"Ewert"=>"Ewert",
			"Exo"=>"Exo","Exo:100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic"=>"Exo (plus all weights and italics)",
			...
			"Josefin%20Sans:400,400italic,100,100italic,300,300italic,600,600italic,700,700italic"=>"Josefin Sans (all weights)",
			...
			"Oldenburg"=>"Oldenburg",
			"Open%20Sans:400,400italic,300,300italic,600,600italic,700,700italic,800,800italic"=>"Open Sans (all weights)",
...
$wt_options = array(
	...
	array(
		...
		array(
			...
			"options" => array(
				'"Raleway", "Helvetica Neue", Helvetica, Arial, sans-serif;' => '"Raleway", "Helvetica Neue", Helvetica, Arial, sans-serif;',
	...
	array(
		...
		array(
			...
			array(
				...
				"id" => "used_googlefonts",
				"default" => array('Open%20Sans:400,400italic,300,300italic,600,600italic,700,700italic,800,800italic', 'Montserrat', 'Raleway:300,400,700', 'Crimson Text'),
			...
			array(
				...
				"id" => "gfonts_code",
				"default" => 'h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6, .wpb_accordion_header a, .wt_pricing_box_sc .wt_pricing_btn .btn, #logo {
